...
public class NuclearBombParticle extends TextureSheetParticle {
    ...
    protected NuclearBombParticle(ClientLevel world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, SpriteSet sprites) {
        super(world, x, y, z, xSpeed, ySpeed, zSpeed);
        this.xd = 0;
        this.yd = 0;
        this.zd = 0;
        this.setSize(0.5F, 0.5F);
        this.quadSize = 0.1F + world.random.nextFloat() * 0.2F;
    ...
    public void tick() {
        ...
        if (this.age++ >= this.lifetime) {
            ...
            Vec3 vec3 = new Vec3(moveToX, moveToY, moveToZ);
            Vec3 movement = vec3.subtract(this.x, this.y, this.z).normalize().scale(0.2F);
            this.xd = movement.x;
            this.yd += movement.y;
            this.zd += movement.z;
    ...
    public static class Factory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            NuclearBombParticle particle = new NuclearBombParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, spriteSet);
