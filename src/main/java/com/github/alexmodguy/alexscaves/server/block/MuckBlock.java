...
public class MuckBlock extends FallingBlockWithColor {
    ...
    public VoxelShape getCollisionShape(BlockState state, BlockGetter level, BlockPos blockPos, CollisionContext context) {
        return context instanceof EntityCollisionContext entityCollisionContext && entityCollisionContext.getEntity() != null && (entityCollisionContext.getEntity().getType().is(ACTagRegistry.SEAFLOOR_DENIZENS) || entityCollisionContext.getEntity() instanceof FallingBlockEntity) ? Shapes.block() : SHAPE;
    }
