...
public class ACEntityRegistry {
    ...
    public static final RegistryObject<EntityType<DepthChargeEntity>> DEPTH_CHARGE = DEF_REG.register("depth_charge", () -> (EntityType) EntityType.Builder.of(DepthChargeEntity::new, MobCategory.MISC).sized(0.4F, 0.4F).setCustomClientFactory(DepthChargeEntity::new).setUpdateInterval(1).setShouldReceiveVelocityUpdates(true).build("depth_charge"));
